...
export const MODULE_DEPENDENCIES: Record<string, string[]> = {
  ...
  // 方案层 ◀ 诊断+分析层
  M14: ['M1', 'M2', 'M3', 'M9'], // 修改方案 ← 全部前置
  M15: ['M14'],            // 分级方案 ← 修改方案
  M17: ['M2', 'M14'],      // 过稿清单 ← 合规 + 修改方案

  // 商业化层 ◀ 诊断+方案层
  M10: ['M2', 'M3'],       // 出海 ← 合规 + 爆款
  M11: ['M9'],             // 互动影游 ← 白金诊断
  M12: ['M2', 'M3', 'M9'], // 精品申报 ← 合规 + 爆款 + 白金
  M13: ['M14'],            // Agent协同 ← 修改方案
  M16: ['M2', 'M14'],      // 多平台 ← 合规 + 修改方案
};
...
export const MODULE_NAMES: Record<string, string> = {
  ...
  M13: 'Agent协同', M14: '修改方案', M15: '分级方案', M16: '多平台适配',
  M17: '过稿清单',
};

/** 冲突模块对：选中A时建议取消B */
export const MODULE_CONFLICTS: [string, string, string][] = [
  ['M14', 'M15', 'M15 包含 M14 的功能，选一个即可'],
  ['M16', 'M17', 'M17 更聚焦过稿，M16 更全面——视需求选'],
];
